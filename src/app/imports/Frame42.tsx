import svgPaths from "./svg-9iu0mrinem";

function ClockClockwise() {
  return (
    <div className="relative shrink-0 size-[17px]" data-name="ClockClockwise">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
        <g id="ClockClockwise">
          <g id="Vector" />
          <path d={svgPaths.p3fc6f980} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M12.2188 6.90625H14.875V4.25" id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.p9c7d260} id="Vector_4" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center py-[6px] relative shrink-0 w-full">
      <ClockClockwise />
      <p className="css-4hzbpn flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic relative text-[#fefefe] text-[13px] tracking-[-0.0762px]">Future Events Only</p>
    </div>
  );
}
...
function LightbulbFilament() {
  return (
    <div className="relative shrink-0 size-[17px]" data-name="LightbulbFilament">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
        <g id="LightbulbFilament">
          <g id="Vector" />
          <path d="M5.84375 15.4062H11.1562" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M8.5 13.2812V9.5625" id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.p267fe100} id="Vector_4" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
          <path d={svgPaths.pda34100} id="Vector_5" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function Moon() {
  return (
    <div className="relative shrink-0 size-[17px]" data-name="Moon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17 17">
        <g id="Moon">
          <g id="Vector" />
          <path d={svgPaths.p19092e80} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </svg>
    </div>
  );
...
function Frame4() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center py-[6px] relative shrink-0 w-full">
      <Moon />
      <p className="css-4hzbpn flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-h-px min-w-px not-italic relative text-[#fefefe] text-[13px] tracking-[-0.0762px]">Dark Mode</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="absolute bg-[#30224e] content-stretch flex flex-col items-start left-[259px] p-[12px] top-[192px] w-[181px]">
...
function Frame9() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.19)] content-stretch flex h-[40px] items-center left-[44px] p-[6px] top-[100px]">
      <Button />
      <Button1 />
    </div>
  );
...
function Frame10() {
  return (
    <div className="absolute bg-[#30224e] content-stretch flex flex-col items-start left-[44px] p-[12px] top-[192px] w-[181px]">
      <div aria-hidden="true" className="absolute border-[0.769px] border-[rgba(254,254,254,0.2)] border-solid inset-0 pointer-events-none" />
      <Frame11 />
      <Frame />
      <Frame12 />
...
export default function Frame7() {
  return (
    <div className="bg-[#30224e] relative size-full">
      <Frame3 />
      <Frame9 />
      <Frame10 />
    </div>
