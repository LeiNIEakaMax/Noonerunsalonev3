import svgPaths from "./svg-ldya7bvb6h";
...
function InputField1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Input Field">
      <p className="css-4hzbpn font-['Inter:Regular',sans-serif] font-normal leading-[1.4] min-w-full not-italic relative shrink-0 text-[#f3f3f3] text-[16px] w-[min-content]">Event Link*</p>
      <Input2 />
    </div>
  );
}
...
function Input3() {
  return (
    <div className="min-w-[120px] relative rounded-[9999px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center min-w-[inherit] overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center min-w-[inherit] px-[16px] py-[12px] relative w-full">
          <p className="css-g0mm18 flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-none min-h-px min-w-px not-italic overflow-hidden relative text-[#b3b3b3] text-[16px] text-ellipsis">Toronto, Scarborough, Mississauga...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.4)] border-solid inset-[-0.5px] pointer-events-none rounded-[9999.5px]" />
    </div>
...
function Button() {
  return (
    <div className="bg-white content-stretch flex h-[40px] items-center justify-between overflow-clip p-[12px] relative shrink-0 w-[308px]" data-name="Button">
